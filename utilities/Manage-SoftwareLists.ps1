...
$Script:CommonPublishers = @{
    ...
    "AMD" = @{
        ...
        ProductName = "*"
        Description = "AMD Drivers & Software"
        Category    = "Hardware/Drivers"
    }
    "NVIDIA" = @{
        Publisher   = "O=NVIDIA*"
        ProductName = "*"
        Description = "NVIDIA Drivers & Software"
        Category    = "Hardware/Drivers"
    }
    "Dell" = @{
        Publisher   = "O=DELL*"
        ProductName = "*"
        Description = "Dell Hardware Tools"
        Category    = "Hardware/Drivers"
    }
    "HP" = @{
        Publisher   = "O=HP INC*"
        ProductName = "*"
        Description = "HP Hardware Tools"
        Category    = "Hardware/Drivers"
    }
    "Lenovo" = @{
        Publisher   = "O=LENOVO*"
        ProductName = "*"
        Description = "Lenovo Hardware Tools"
        Category    = "Hardware/Drivers"
    }
}
