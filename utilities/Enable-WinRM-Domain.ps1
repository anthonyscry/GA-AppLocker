<#
.SYNOPSIS
    Creates a GPO to enable WinRM across all domain-joined computers and forces GP refresh.

.DESCRIPTION
    This script will:
    1. Create a new GPO to enable and configure WinRM
    2. Link it to Domain Controllers, Member Servers, and Workstations
    3. Configure firewall exceptions
    4. Force group policy refresh across all domain computers
...
# GPO Name
$defaultGPOName = "Enable WinRM - Enterprise"
...
Write-Host "  Remove-GPO -Name '$gpoName'" -ForegroundColor White
Write-Host ""
