...
```
GUI/
├── Start-AppLockerGUI.ps1    # Main WPF application with embedded XAML
...
Invoke-ScriptAnalyzer -Path ./GUI/Start-AppLockerGUI.ps1 -Severity Warning
...
- XAML is embedded as a here-string in `Start-AppLockerGUI.ps1`
